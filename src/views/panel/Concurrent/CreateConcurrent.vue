    ...
    <form method="post">
      <div class="card-body">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="model_type" name="model_type" placeholder="Model Type..." required
            autocomplete="off">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="repeated_every" name="repeated_every"
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="extra" name="extra" placeholder="Extra..." required
            autocomplete="off">
