    ...
    <form method="post">
      <div class="card-body">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="fname" name="fullname" placeholder="Full Name..." required autofocus
            autocomplete="off" v-model="client.fullname">
        ...
        <div class="row g-1 mb-1">
          <div class="col">
            ...
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="id_type" name="id_type" placeholder="ID Type..."
      ...
      <div class="card-footer text-end">
        <button class="btn text-white btn-primary" @click.prevent="addClient">
          <svg class="button-icon" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2"
