    ...
    <form method="post">
      <div class="card-body">
        ...
        <div class="form-floating mb-3">
          <input type="text" class="form-control" id="title" v-model="service.title" name="title" placeholder="Title..."
        ...
        <div class="row g-1 mb-1">
          <div class="col">
            <div class="form-floating mb-3">
              <input type="date" class="form-control" id="before_date" v-model="service.before_date" name="before_date"
            ...
            <div class="form-floating mb-3">
              <input type="date" class="form-control" id="exact_date" v-model="service.exact_date" name="exact_date"
            ...
            <div class="form-floating mb-3">
              <input type="date" class="form-control" id="after_date" v-model="service.after_date" name="after_date"
